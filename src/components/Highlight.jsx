import titaniumImg from '../assets/img/titanium-design.jpg'
import iosImg from '../assets/img/ios-features.jpg'
import chipImg from '../assets/img/chip-a18-pro.jpg'
            ...
            <div className="max-w-7xl mx-auto"  id="design">
                ...
                <div className="grid grid-cols-2 gap-8 mb-16 text-center">
                    <div className="bg-gray-900 rounded-3xl p-8">
                        <img className="w-full rounded-2xl mb-4" src={titaniumImg} alt="iphone-titanium" />
                    ...
                    <div className="bg-gray-900 rounded-3xl p-8">
                        <img className="w-full rounded-2xl mb-4" src={iosImg} alt="ios 2025" />
                ...
                <div className="bg-gray-900 rounded-3xl p-12 mb-16" id="performance">
                    ...
                    <img className="w-full rounded-2xl mb-4" src={chipImg} alt="chip-a18" />
